//AJ_ALLE_22012024
page 50126 "Quarantine Transfer To Store"
{
    PageType = List;
    ApplicationArea = All;
    UsageCategory = Lists;
    SourceTable = "Item Journal Line";
    SourceTableView = where("Journal Template Name" = filter('TRANSFER'), "Journal Batch Name" = filter('DEFAULT'));
        ...
        area(Content)
        {
            repeater(Control1)
            {
                ...
                field("Posting Date"; Rec."Posting Date")
                {
                    ...
                    Editable = true; //PT-FBTS 27-09-24
                }
    ...
    begin
        ...
        rec.SetRange("Quarantine Location Boolean", true);
        //rec.SetFilter("Entry Type", '%1', Rec."Entry Type"::" ");
    end;
}