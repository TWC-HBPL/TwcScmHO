page 50244 "Job work Transfer Order List" //PT-FBTS-JiraID-867
{
    ApplicationArea = All;
    Caption = 'Job work Transfer Order List';
    CardPageID = "Job work Transfer Order";
    // SourceTableView = where("job work" = filter(true));
    Editable = false;
    PageType = List;
